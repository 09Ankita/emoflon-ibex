	...
	import org.emoflon.ibex.tgg.nactggnodetonachenshinnodewithoutotherformularbridge.NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_FWDMatcher
	import org.emoflon.ibex.tgg.nactggnodetonachenshinnodewithoutotherformularbridge.NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_PROTOCOLMatcher
	import org.emoflon.ibex.tgg.nactggnodetonachenshinnodewithoutotherformularbridge.NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_MODELGENMatcher
	import org.emoflon.ibex.tgg.nactggnodetonachenshinnodewithoutotherformularbridge.NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_BWDMatcher
	import org.emoflon.ibex.tgg.nactggnodetonachenshinnodewithoutotherformularbridge.NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_CCMatcher
	...
	import org.emoflon.ibex.tgg.nactggnodetonachenshinnodewithotherformularbridge.NACTGGNodeToNACHenshinNodeWithOtherFormularBridge_FWDMatcher
	import org.emoflon.ibex.tgg.nactggnodetonachenshinnodewithotherformularbridge.NACTGGNodeToNACHenshinNodeWithOtherFormularBridge_PROTOCOLMatcher
	import org.emoflon.ibex.tgg.nactggnodetonachenshinnodewithotherformularbridge.NACTGGNodeToNACHenshinNodeWithOtherFormularBridge_MODELGENMatcher
	import org.emoflon.ibex.tgg.nactggnodetonachenshinnodewithotherformularbridge.NACTGGNodeToNACHenshinNodeWithOtherFormularBridge_BWDMatcher
	import org.emoflon.ibex.tgg.nactggnodetonachenshinnodewithotherformularbridge.NACTGGNodeToNACHenshinNodeWithOtherFormularBridge_CCMatcher
	...
	class MoflonToHenshinTransformation{	
		...
		private def getSynch() {
			new EventDrivenTransformationRuleGroup(
				...
				getNACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_FWD(),
				getNACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_BWD(),
				getNACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_PROTOCOL(), 
				...
				getNACTGGNodeToNACHenshinNodeWithOtherFormularBridge_FWD(),
				getNACTGGNodeToNACHenshinNodeWithOtherFormularBridge_BWD(),
				getNACTGGNodeToNACHenshinNodeWithOtherFormularBridge_PROTOCOL()
				)
		}
		...
		private def get_MODELGEN(){
			new EventDrivenTransformationRuleGroup(
				...
				getNACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_MODELGEN(), 
				...
				getNACTGGNodeToNACHenshinNodeWithOtherFormularBridge_MODELGEN()
			 )
		}
		...
		private def get_CC(){
			new EventDrivenTransformationRuleGroup(
				...
				getNACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_CC(), 
				...
				getNACTGGNodeToNACHenshinNodeWithOtherFormularBridge_CC()
			)
		}
		...
		private def getNACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_FWD() {
			createRule.name("NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_FWD").precondition(NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_FWDMatcher.querySpecification).action(
				CRUDActivationStateEnum.CREATED) [
				         tggRuntimeUtil.addOperationalRuleMatch("NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge", it)
				].action(CRUDActivationStateEnum.DELETED)[
				         tggRuntimeUtil.removeOperationalRuleMatch(it)]
			.addLifeCycle(				
				Lifecycles.getDefault(false, true)
		...
		private def getNACTGGNodeToNACHenshinNodeWithOtherFormularBridge_FWD() {
			createRule.name("NACTGGNodeToNACHenshinNodeWithOtherFormularBridge_FWD").precondition(NACTGGNodeToNACHenshinNodeWithOtherFormularBridge_FWDMatcher.querySpecification).action(
				CRUDActivationStateEnum.CREATED) [
				         tggRuntimeUtil.addOperationalRuleMatch("NACTGGNodeToNACHenshinNodeWithOtherFormularBridge", it)
				].action(CRUDActivationStateEnum.DELETED)[
				         tggRuntimeUtil.removeOperationalRuleMatch(it)]
			.addLifeCycle(				
				Lifecycles.getDefault(false, true)
		...
		private def getNACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_PROTOCOL() {
			createRule.name("NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_PROTOCOL").precondition(NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_PROTOCOLMatcher.querySpecification).action(
				CRUDActivationStateEnum.CREATED) []
				.action(CRUDActivationStateEnum.DELETED)[
				tggRuntimeUtil.addBrokenMatch(it)]
			.addLifeCycle(				
		...
		private def getNACTGGNodeToNACHenshinNodeWithOtherFormularBridge_PROTOCOL() {
			createRule.name("NACTGGNodeToNACHenshinNodeWithOtherFormularBridge_PROTOCOL").precondition(NACTGGNodeToNACHenshinNodeWithOtherFormularBridge_PROTOCOLMatcher.querySpecification).action(
				CRUDActivationStateEnum.CREATED) []
				.action(CRUDActivationStateEnum.DELETED)[
				tggRuntimeUtil.addBrokenMatch(it)]
			.addLifeCycle(				
		...
		private def getNACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_MODELGEN() {
			createRule.name("NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_MODELGEN").precondition(NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_MODELGENMatcher.querySpecification).action(
				CRUDActivationStateEnum.CREATED) [
				         tggRuntimeUtil.addOperationalRuleMatch("NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge", it)
				].action(CRUDActivationStateEnum.DELETED)[
				         tggRuntimeUtil.removeOperationalRuleMatch(it)]
		...
		private def getNACTGGNodeToNACHenshinNodeWithOtherFormularBridge_MODELGEN() {
			createRule.name("NACTGGNodeToNACHenshinNodeWithOtherFormularBridge_MODELGEN").precondition(NACTGGNodeToNACHenshinNodeWithOtherFormularBridge_MODELGENMatcher.querySpecification).action(
				CRUDActivationStateEnum.CREATED) [
				         tggRuntimeUtil.addOperationalRuleMatch("NACTGGNodeToNACHenshinNodeWithOtherFormularBridge", it)
				].action(CRUDActivationStateEnum.DELETED)[
				         tggRuntimeUtil.removeOperationalRuleMatch(it)]
		...
		private def getNACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_BWD() {
			createRule.name("NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_BWD").precondition(NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_BWDMatcher.querySpecification).action(
				CRUDActivationStateEnum.CREATED) [
				         tggRuntimeUtil.addOperationalRuleMatch("NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge", it)
				].action(CRUDActivationStateEnum.DELETED)[
				         tggRuntimeUtil.removeOperationalRuleMatch(it)]
		...
		private def getNACTGGNodeToNACHenshinNodeWithOtherFormularBridge_BWD() {
			createRule.name("NACTGGNodeToNACHenshinNodeWithOtherFormularBridge_BWD").precondition(NACTGGNodeToNACHenshinNodeWithOtherFormularBridge_BWDMatcher.querySpecification).action(
				CRUDActivationStateEnum.CREATED) [
				         tggRuntimeUtil.addOperationalRuleMatch("NACTGGNodeToNACHenshinNodeWithOtherFormularBridge", it)
				].action(CRUDActivationStateEnum.DELETED)[
				         tggRuntimeUtil.removeOperationalRuleMatch(it)]
		...
		private def getNACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_CC() {
			createRule.name("NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_CC").precondition(NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge_CCMatcher.querySpecification).action(
				CRUDActivationStateEnum.CREATED) [
				         tggRuntimeUtil.addOperationalRuleMatch("NACTGGNodeToNACHenshinNodeWithoutOtherFormularBridge", it)
				].action(CRUDActivationStateEnum.DELETED)[
				         tggRuntimeUtil.removeOperationalRuleMatch(it)]
		...
		private def getNACTGGNodeToNACHenshinNodeWithOtherFormularBridge_CC() {
			createRule.name("NACTGGNodeToNACHenshinNodeWithOtherFormularBridge_CC").precondition(NACTGGNodeToNACHenshinNodeWithOtherFormularBridge_CCMatcher.querySpecification).action(
				CRUDActivationStateEnum.CREATED) [
				         tggRuntimeUtil.addOperationalRuleMatch("NACTGGNodeToNACHenshinNodeWithOtherFormularBridge", it)
				].action(CRUDActivationStateEnum.DELETED)[
				         tggRuntimeUtil.removeOperationalRuleMatch(it)]
