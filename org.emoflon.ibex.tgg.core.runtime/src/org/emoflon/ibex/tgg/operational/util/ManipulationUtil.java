...
public class ManipulationUtil {
	...
	// consistency
	public void createNonCorrNodes(IMatch match, HashMap<String, EObject> comatch,
	...
	public Collection<RuntimeEdge> createEdges(IMatch match, HashMap<String, EObject> comatch,
	...
	private RuntimeEdge mapToRuntimeEdge(TGGRuleEdge edge, IMatch match, HashMap<String, EObject> comatch,
	...
	// changed from for each construct to collection.stream() construct for
	// consistency
	public void createCorrs(IMatch match, HashMap<String, EObject> comatch, Collection<TGGRuleCorr> greenCorrs,
	...
	private EObject defaultCreateNode(IMatch match, TGGRuleNode node, Resource resource){
		return this.createNode(match, node, resource, false, "");
	}
	
	// changed from for each construct to collection.stream() construct for
	// consistency and changed Node creation
	private EObject createNode(IMatch match, TGGRuleNode node, Resource resource, boolean isManipulated, String pluginID) {
	...
	public EObject getVariableByName(String name, HashMap<String, EObject> comatch, IMatch match) {
