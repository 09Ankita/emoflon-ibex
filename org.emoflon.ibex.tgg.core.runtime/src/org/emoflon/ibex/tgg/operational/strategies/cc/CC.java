...
public abstract class CC extends OperationalStrategy {
	...
	private THashSet<RuntimeEdge> getGreenEdges(IMatch match, HashMap<String, EObject> comatch, String ruleName) {
		...
		result.addAll(ManipulationUtil.getInstance().createEdges(match, comatch, ruleInfos.getGreenSrcEdges(ruleName), false, isManipulated, pluginID));
		result.addAll(ManipulationUtil.getInstance().createEdges(match, comatch, ruleInfos.getGreenTrgEdges(ruleName), false, isManipulated, pluginID));
		return result;
	}

	private THashSet<RuntimeEdge> getBlackEdges(IMatch match, HashMap<String, EObject> comatch, String ruleName) {
		THashSet<RuntimeEdge> result = new THashSet<>();
		result.addAll(ManipulationUtil.getInstance().createEdges(match, comatch, ruleInfos.getBlackSrcEdges(ruleName), false, isManipulated, pluginID));
		result.addAll(ManipulationUtil.getInstance().createEdges(match, comatch, ruleInfos.getBlackTrgEdges(ruleName), false, isManipulated, pluginID));
		return result;
	}
